================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : S3Controller Project Overview
===============================================================================

The application wizard has created this S3Controller application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your S3Controller application.
...
S3Controller.h
    ...
    project specific headers and declares the CS3ControllerApp application class.
...
S3ControllerDlg.h, S3ControllerDlg.cpp - the dialog
...
StdAfx.h, StdAfx.cpp
    ...
    named S3Controller.pch and a precompiled types file named StdAfx.obj.
